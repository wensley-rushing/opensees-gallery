...
#       model.geomTransf("Linear", 2, (0, 0, 1))
    ...
    model.element(element, 2, (2, 3), section=section, transform=2)
    model.element(element, 3, (3, 4), section=section, transform=2)
    model.element(element, 4, (4, 5), section=section, transform=1)

    model.pattern("Plain", 1, "Constant")
    model.eleLoad("-type", "BeamUniform",  5, 0, ele=1, pattern=1)
