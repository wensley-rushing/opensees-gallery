...
def create_portal(vertical = 2):
    ...
    model.section("Elastic", 1, 29e3*ksi, A, Iz, Iy, G, J)
    ...
    model.element("ForceFrame", 1, (2,3), section=1, transform=1, shear=0) # column
    model.element("ForceFrame", 2, (3,4), section=1, transform=2, shear=0) # girder
    model.element("ForceFrame", 3, (4,1), section=1, transform=3, shear=0) # column
