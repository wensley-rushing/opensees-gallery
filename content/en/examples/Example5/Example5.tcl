...
# ----------------------------
proc create_model elem_name {

#  set elem_name  [lindex argv 1] ; #ForceFrame; # nonlinearBeamColumn; # 
  ...
  element $elem_name  1   1   5   $np  $colSec    1
  element $elem_name  2   2   6   $np  $colSec    1
  element $elem_name  3   3   7   $np  $colSec    1
  element $elem_name  4   4   8   $np  $colSec    1

  element $elem_name  5   5  10   $np  $colSec    1
  element $elem_name  6   6  11   $np  $colSec    1
  element $elem_name  7   7  12   $np  $colSec    1
  element $elem_name  8   8  13   $np  $colSec    1

  element $elem_name  9  10  15   $np  $colSec    1
  element $elem_name 10  11  16   $np  $colSec    1
  element $elem_name 11  12  17   $np  $colSec    1
  element $elem_name 12  13  18   $np  $colSec    1
  ...
  #                  tag ndI ndJ nPts    secID   transf
  element $elem_name  13  5   6   $np  $beamSec     2
  element $elem_name  14  6   7   $np  $beamSec     2
  element $elem_name  15  7   8   $np  $beamSec     2
  element $elem_name  16  8   5   $np  $beamSec     2

  element $elem_name  17 10  11   $np  $beamSec     2
  element $elem_name  18 11  12   $np  $beamSec     2
  element $elem_name  19 12  13   $np  $beamSec     2
  element $elem_name  20 13  10   $np  $beamSec     2

  element $elem_name  21 15  16   $np  $beamSec     2
  element $elem_name  22 16  17   $np  $beamSec     2
  element $elem_name  23 17  18   $np  $beamSec     2
  element $elem_name  24 18  15   $np  $beamSec     2
