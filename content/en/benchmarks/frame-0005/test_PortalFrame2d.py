...
def test_PortalFrame2d():
    ...
    comparisonResults = [[1.2732, 0.4313, 0.2420, 0.1602, 0.1190, 0.0951, 0.0795], # SAP2000
                         [1.2732, 0.4313, 0.2420, 0.1602, 0.1190, 0.0951, 0.0795]] # SeismoStruct
    print("\n\nPeriod Comparisons:")
